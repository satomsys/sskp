...
<head>
  ...
  <title>シワシミ対策の鍵！からだの奥のめぐり｜ねむりとめぐりの研究所＜公式＞</title>
  <meta name="description" content="２つのめぐりとは「血行」と「代謝」「血行」も「代謝」も一日の中でリズムがあり、朝一早くスイッチを入れることが大切です。">
  <meta name="keywords" content="ドモホルンリンクル,ドモホルン,ドモ,再春館製薬所,再春館,めぐり,代謝,血行">
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.saishunkan.co.jp/domo/beautyhabit/lab/meguri03.html">
  <meta property="og:title" content="シワシミ対策の鍵！からだの奥のめぐり｜ねむりとめぐりの研究所＜公式＞">
  <meta property="og:description" content="２つのめぐりとは「血行」と「代謝」「血行」も「代謝」も一日の中でリズムがあり、朝一早くスイッチを入れることが大切です。" />
  ...
  <div class="wrap">
    ...
    <div class="header">
      <div class="header_inner">
        ...
        <div class="h2_container sp">
          <h2>
            <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/title_01_sp.png" alt="シワシミ対策の鍵！からだの奥のめぐり" />
          </h2>
        </div><!-- .h2_container sp -->
        <div class="h2_container pc" style="margin-top:44px;">
          <h2>
            <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/title_01_pc.png" alt="シワシミ対策の鍵！からだの奥のめぐり" />
          </h2>
        </div><!-- .h2_container pc -->
      </div><!-- .header_inner -->
    </div><!-- .header -->
    ...
    <div class="content">
      <div class="content_inner">
        ...
        <div class="column_01 meguri03_01">
          <div>
            <div class="box_clear">
              <div class="img_container">
                <img src="/assets/ps/domo/beautyhabit/lab/img/meguri03/01.png" /> 
              </div>
              <div class="text_01">
                <p class="bold">2つの「めぐり」とは、<br />①血行（からだ全体を流れるめぐり）と、<br />②代謝（細胞の中のめぐり）です。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <h3>
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/title_02_pc.png" alt="①「血行」は、からだ中に栄養や酸素を運んでいる血液の流れ" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/title_02_sp.png" alt="①「血行」は、からだ中に栄養や酸素を運んでいる血液の流れ" />
        </h3>
        
        <div class="column_02 clearfix meguri03_02">
          <div>
            <div class="box_clear">
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/02_pc.png" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/02_sp.png" />
            </div>
          </div>
          <div>
            <div class="box_clear">
              <p>からだ中の血管の総延長は、末梢の毛細血管まで入れると約10万キロ。なんと地球を約2周半する長さです。それゆえ血行は、老廃物などが溜まると、すぐに滞ってしまいます。<br />滞ると、細胞に栄養が行きわたらなくなって、お肌のくすみにはじまり、シワやシミにつながることも。</p>
              <p><span class="pink large bold">からだ中を駆けめぐるこの「めぐり」が、栄養の運び屋「血行」</span>です。</p>
            </div>
          </div>
        </div>

        <h3 class="meguri03_03">
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/title_03_pc.png" alt="②「代謝」は、血液から栄養を取り込み、よぶんなものを捨てて、細胞を働かせること" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/title_03_sp.png" alt="②「代謝」は、血液から栄養を取り込み、よぶんなものを捨てて、細胞を働かせること" />
        </h3>
        
        <div class="column_02 clearfix meguri03_04">
          <div>
            <div class="box_clear">
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/03_pc.png" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/meguri03/03_sp.png" />
            </div>
          </div>
          <div>
            <div class="box_clear">
              <p>細胞が動くために、必要な栄養やエネルギーをつくり出しますが、同時に老廃物もできてしまいます。また、紫外線などのダメージを受けても老廃物ができ、シワやシミなどの老化につながります。</p>
              <p class="pink large bold">よぶんなものを捨てて、血液から送られた栄養や酸素を取り込む。</p>
              <p>この、目に見えない細胞の中の「めぐり」が「代謝」です。</p>
            </div>
          </div>
        </div>
        
        <div class="column_01 meguri03_05">
          <div>
            <div class="box_clear">
              <div class="text_01">
                <p class="large bold">「血行」と「代謝」がめぐる鍵、それは日中にありました。</p>
                <p>「血行」も「代謝」も一日の中でリズムがあり、朝はその働きがゆるやかになります。一方で、日中は紫外線やストレスなどのダメージを受けやすいとき。<br />だから「血行」も「代謝」も早くスイッチを入れて、日中のダメージをはねのけたいものです。このスイッチが入れば、年齢肌の悩みにも、うれしいサインが出てきます。</p>
              </div>
            </div>
          </div>
        </div>
