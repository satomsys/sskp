...
<head>
  ...
  <title>月桃葉エキス｜ねむりとめぐりの研究所｜飲む＆食べるドモホルンリンクル＜公式＞</title>
  <meta name="description" content="月桃は、ポリフェノールが豊富で、その抗酸化作用にも注目されています。その葉は沖縄の伝統菓子「ムーチ―」に使われています。">
  <meta name="keywords" content="ドモホルンリンクル,ドモホルン,ドモ,再春館製薬所,再春館,成分,配合成分,月桃葉">
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.saishunkan.co.jp/domo/beautyhabit/lab/raw_material02.html">
  <meta property="og:title" content="月桃葉エキス｜ねむりとめぐりの研究所｜飲む＆食べるドモホルンリンクル＜公式＞">
  <meta property="og:description" content="月桃は、ポリフェノールが豊富で、その抗酸化作用にも注目されています。その葉は沖縄の伝統菓子「ムーチ―」に使われています。" />
  ...
  <div class="wrap">
    ...
    <div class="header">
      <div class="header_inner">
        ...
        <div class="h2_container sp">
          <h2>
            <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/01_sp.png" alt="お肌をはつらつとさせる月桃葉エキス" />
          </h2>
        </div><!-- .h2_container sp -->
        <div class="h2_container pc" style="margin-top:44px;">
          <h2>
            <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/01_pc.png" alt="お肌をはつらつとさせる月桃葉エキス" />
          </h2>
        </div><!-- .h2_container pc -->
      </div><!-- .header_inner -->
    </div><!-- .header -->
    ...
    <div class="content">
      <div class="content_inner clearfix">
        ...
        <div class="column_01 raw_material02_01">
          <div>
            <h6>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/02_pc.png" alt="月桃葉エキスはこんな方にオススメ" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/02_sp.png" alt="月桃葉エキスはこんな方にオススメ" />
            </h6>
            <div class="box_clear">
              <div class="text_01">
        ...
        <h3>
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/03_pc.png" alt="月桃葉エキスとは？" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/03_sp.png" alt="月桃葉エキスとは？" />
        </h3>

        <div class="column_01 raw_material02_02">
          <div>
            <div class="box_clear">
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/04_pc.png" alt="月桃葉エキス" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/04_sp.png" alt="月桃葉エキス" />
              </div>
              <div class="text_01">
                <p>月桃は、ショウガ科・ハナミョウガ属に分類される常緑多年草で、沖縄では、古くからさとうきび畑の防風林として植えられてきました。ふっくらと、まるで三日月のような形で、桃の花を思わせる白やピンクの花の色から月桃と呼ばれるようになったといわれています。</p>
                <p>その葉は、<span class="pink large bold">沖縄の伝統菓子「ムーチー（餅・鬼餅）」にも使われ、傷みやカビを防ぐ</span>など、沖縄の人々にはなじみの深い植物です。</p>

              </div>
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/05_pc.png" alt="※生産地：日本（沖縄県）月桃が栽培されているのは、沖縄の浜比嘉島という小さな島。しっかりとした根をはる生命力ある月桃から、より良質なエキスが取れるように、ひとつひとつを見分けながら、刈り取りからエキス作りまで、熟練者が丹念な手作業で行います。" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/05_sp.png" alt="※生産地：日本（沖縄県）月桃が栽培されているのは、沖縄の浜比嘉島という小さな島。しっかりとした根をはる生命力ある月桃から、より良質なエキスが取れるように、ひとつひとつを見分けながら、刈り取りからエキス作りまで、熟練者が丹念な手作業で行います。" />
              </div>
            </div>
          </div>
        </div>

        <div class="column_01 raw_material02_03">
          <div>
            <h6>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/06_pc.png" alt="月桃の効果" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material02/06_sp.png" alt="月桃の効果" />
            </h6>
            <div class="box_clear">
              <div class="text_01">
                <p><span class="pink large bold">ポリフェノールが豊富で、その抗酸化作用も注目</span>されている月桃。<br />線維芽細胞賦活、コラーゲン産生、コラーゲン分解抑制など、多様なアプローチでお肌づくりのサポートが期待されます。</p>
              </div>
            </div>
          </div>
        </div>
