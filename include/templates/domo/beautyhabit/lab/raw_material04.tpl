...
<head>
  ...
  <title>ゆず種子エキス｜ねむりとめぐりの研究所｜飲む＆食べるドモホルンリンクル＜公式＞</title>
  <meta name="description" content="ゆずが持つ成分であるリモニンには、発がん物質を排出する働きや 抗炎症作用などがあることが知られています。">
  <meta name="keywords" content="ドモホルンリンクル,ドモホルン,ドモ,再春館製薬所,再春館,成分,配合成分,ゆず種子">
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.saishunkan.co.jp/domo/beautyhabit/lab/raw_material04.html">
  <meta property="og:title" content="ゆず種子エキス｜ねむりとめぐりの研究所｜飲む＆食べるドモホルンリンクル＜公式＞">
  <meta property="og:description" content="ゆずが持つ成分であるリモニンには、発がん物質を排出する働きや 抗炎症作用などがあることが知られています。" />
  ...
  <div class="wrap">
    ...
    <div class="header">
      <div class="header_inner">
        ...
        <div class="h2_container sp">
          <h2>
            <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/01_sp.png" alt="体を温めるゆずの力ゆず種子エキス" />
          </h2>
        </div><!-- .h2_container sp -->
        <div class="h2_container pc" style="margin-top:44px;">
          <h2>
            <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/01_pc.png" alt="体を温めるゆずの力ゆず種子エキス" />
          </h2>
        </div><!-- .h2_container pc -->
      </div><!-- .header_inner -->
    </div><!-- .header -->
    ...
    <div class="content">
      <div class="content_inner clearfix">
        ...
        <div class="column_01 raw_material04_01">
          <div>
            <h6>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/02_pc.png" alt="ゆず種子エキスはこんな方にオススメ" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/02_sp.png" alt="ゆず種子エキスはこんな方にオススメ" />
            </h6>
            <div class="box_clear">
              <div class="text_01">
                <ul class="raw_material_list">
                  <li><span class="bold">美肌を目指したい方</span></li>
                  <li><span class="bold">ストレスをやわらげたい方</span></li>
        ...
        <h3>
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/03_pc.png" alt="ゆず種子エキスとは？" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/03_sp.png" alt="ゆず種子エキスとは？" />
        </h3>

        <div class="column_01 raw_material04_02">
          <div>
            <div class="box_clear">
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/04_pc.png" alt="ゆず" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/04_sp.png" alt="ゆず" />
              </div>
              <div class="text_01">
                <p>日本では、一年でもっとも夜が長くなる冬至（毎年12月22日頃）の日に、ゆず湯に入る習慣があります。 <span class="pink large bold">ゆず湯には血行を促進して女性に多い冷え症を緩和</span>したり、体を温めることで風邪を予防する効果があるといわれており、このような効果は、香りのもとである精油成分「リモネン」の働きだと考えられています。</p>
                <p><span class="pink large bold">リモネンは、血行促進作用やリラックス作用があり、心と体を癒す効果</span>が明らかになってきています。<br />さらに、このゆずは、果実や皮だけでなく種子にも、体の巡りをよくする力が秘められていました。</p>

              </div>
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/05_pc.png" alt="※生産地：日本（高知県）ゆずの生産地である高知県安芸（あき）市では、幕末の時代からゆず栽培が盛んで、今では、日本一の収穫量を誇っています。ゆずは、とても手がかかる果実。虫がつきやすいため、実や葉のチェックが欠かせません。また、日当たりのために山を切り拓いてつくられた畑は、傾斜がきつく収穫もひと苦労です。そんな中、生産者の人々は 1個1個ていねいに手作業で摘み取っていくのです。" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/05_sp.png" alt="※生産地：日本（高知県）ゆずの生産地である高知県安芸（あき）市では、幕末の時代からゆず栽培が盛んで、今では、日本一の収穫量を誇っています。ゆずは、とても手がかかる果実。虫がつきやすいため、実や葉のチェックが欠かせません。また、日当たりのために山を切り拓いてつくられた畑は、傾斜がきつく収穫もひと苦労です。そんな中、生産者の人々は 1個1個ていねいに手作業で摘み取っていくのです。" />
              </div>
            </div>
          </div>
        </div>
        ...
        <h3>
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/06_pc.png" alt="ゆず種子エキスの力" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/06_sp.png" alt="ゆず種子エキスの力" />
        </h3>
        
        <div class="column_02 clearfix raw_material04_03">
          <div>
            <div class="box_clear">
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/07_pc.png" alt="ゆず種子" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material04/07_sp.png" alt="ゆず種子" />
              </div>
            </div>
          </div>
          <div>
            <div class="box_clear">
              <div class="raw_material04_03_01">
                <p>丹精込めてつくられた「ゆず」の果実は、お肌によいビタミンCが豊富。また、果実だけでなく、ゆずの種子にもお肌によい働きがあります。</p>
                <p>ゆずが持つ成分である<span class="pink large bold">リモニンには、発がん物質を排出する働きや抗炎症作用などがある</span>ことが知られています。 ゆずの種子には、なんと果汁の約1800倍のリモニンが含まれていたのです。</p>
                <p>ゆず種子エキスには、お肌によい成分がぎゅっと詰め込まれ、体の中から私たちのお肌を健やかに保ってくれることが期待できます。</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul class="bh-osusume__clm">
              ...
              <li class="bh-osusume__clm__li" style="height: 450px;">
                <a href="/domo/beautyhabit/lab/raw_material03.html" class="bh-lab">
                  <div class="bh-osusume__spBox">
                    <div class="bh-osusume__thumb"><img src="/assets/ps/domo/beautyhabit/common/img/14.jpg?20161107" alt=""></div>
                    <div class="bh-osusume__spBox__right">
                      <p class="bh-osusume__category"><img src="/assets/ps/domo/beautyhabit/top/img/title_panel_labo_01.png" alt="ねむりとめぐりの研究所"></p>
                      <p class="bh-osusume__subTitle">肌にハリを与えるプロテオグリカン</p>
                    </div>
                  </div>
                  <div class="bh-osusume__text">お肌のハリが失われるのは、プロテオグリカンの減少が一因に。</div>
                </a>
              </li>
              <li class="bh-osusume__clm__li" style="height: 450px;">
