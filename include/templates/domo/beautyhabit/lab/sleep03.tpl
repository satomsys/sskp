...
<head>
  ...
  <title>【調査】4週間の摂取で変化！？しわ編｜ねむりとめぐりの研究所＜公式＞</title>
  <meta name="description" content="眠りの質を高めることで「しわ」にどのような変化があるのか、調査をしました。">
  <meta name="keywords" content="ドモホルンリンクル,ドモホルン,ドモ,再春館製薬所,再春館,飲むドモホルンリンクル,睡眠,睡眠の質,ドリンク">
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.saishunkan.co.jp/domo/beautyhabit/lab/sleep03.html">
  <meta property="og:title" content="【調査】4週間の摂取で変化！？しわ編｜ねむりとめぐりの研究所＜公式＞">
  <meta property="og:description" content="眠りの質を高めることで「しわ」にどのような変化があるのか、調査をしました。" />
  ...
  <div class="wrap">
    ...
    <div class="header">
      <div class="header_inner">
        ...
        <div class="h2_container sp">
          <h2>
            <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_01_sp.png" alt="【調査】4週間の摂取で変化!?しわ編" />
          </h2>
        </div><!-- .h2_container sp -->
        <div class="h2_container pc" style="margin-top:44px;">
          <h2>
            <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_01_pc.png" alt="【調査】4週間の摂取で変化!?しわ編" />
          </h2>
        </div><!-- .h2_container pc -->
      </div><!-- .header_inner -->
    </div><!-- .header -->
    ...
    <div class="content">
      <div class="content_inner">
        ...
        <div class="balloon-top">今回の記事では、私たちが実験・調査したしわやしみ、キメといったお肌お悩みと睡眠との関係をご紹介したいと思います。</div>
        
        <div class="column_01">
          <div>
            <h6>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_02_pc.png" alt="睡眠とお肌の悩みと、しわとの関連性を調べるため、下記の条件にて調査を行いました。" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_02_sp.png" alt="睡眠とお肌の悩みと、しわとの関連性を調べるため、下記の条件にて調査を行いました。" />
            </h6>
            <div class="box_clear">
              <div class="text_01">
                <ul>
                  <li><span class="bold large">睡眠前に眠りの質を高めるドリンクを摂取</span></li>
                  <li><span class="bold large">調査母数：23名</span></li>
                  <li><span class="bold large">平均年齢：45.7歳</span></li>
        ...
        <div class="column_02 clearfix">
          <div>
            <h5>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_03_pc.png" alt="シワ個数の推移" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_03_sp.png" alt="シワ個数の推移" />
            </h5>
            <div class="box_white sleep03_02">
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/01_pc.png" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/01_sp.png" />
            </div>
          </div>
          <div>
            <div class="box_clear">
              <p>その結果、グラフでもわかるとおり<span class="pink large bold">シワの個数が87％まで減少</span>していることがわかりました。<br class="sp" />このグラフは、飲用前と飲用後で同じ箇所のシワの個数を計測して増減の割合を算出したものです。<br />この数字は、23名の平均数値ですが、人によっては、<span class="pink large bold">4週間でほぼ半分の数値なった方も認められました。</span><br class="sp" />その詳細を見ていきましょう。</p>
            </div>
          </div>
        </div>
        
        <div class="gradation sleep03_03">
          <div class="column_01">
            <h4>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_04_pc.png" alt="眠りの質を高めることで、しわにどのような変化があるのか？" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_04_sp.png" alt="眠りの質を高めることで、しわにどのような変化があるのか？" />
            </h4>
          </div>
          <div class="balloon-bottom">下記は、飲用前後のお肌の撮影画像とお肌解析画像、そしてそれらを数値化した表です。</div>
          <div class="column_02 heightLine clearfix">
            <div>
              <h5>
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_05_pc.png" alt="45歳女性お肌の撮影画像とお肌解析画像" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_05_sp.png" alt="45歳女性お肌の撮影画像とお肌解析画像" />
              </h5>
              <div class="box_white">
                <img src="/assets/ps/domo/beautyhabit/lab/img/sleep03/02_pc.png" />
              </div>
            </div>
            <div>
              <h5>
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_06_pc.png" alt="47歳女性お肌の撮影画像とお肌解析画像" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/sleep03/title_06_sp.png" alt="47歳女性お肌の撮影画像とお肌解析画像" />
              </h5>
              <div class="box_white">
                <img src="/assets/ps/domo/beautyhabit/lab/img/sleep03/03_pc.png" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="column_01">
          <div>
            <div class="box_clear">
              <div class="text_01">
                <p>数値表の上にある「シワ個数」というのは、1mm四方仕様の中にしわがいくつあるか数えたものです。濃いシワも薄いシワも、短いものも長いものも1つとしてカウントしました。<br />また「シワ体積率」は、あるしわに対して「幅」と「深さ」を計測しました。<br />「幅」が狭くなったり、「深さ」が浅くなると数値が下がり、しわが改善したと判断することができます。</p>
                <p>撮影画像の「飲用前」「飲用4週間後」を見比べてみてください。飲用前に比べて、<span class="pink large bold">シワの個数やシワの深さがなくなっている</span>ことがわかります。<br />また、解析画像でみても<span class="pink large bold">しわの深さが浅くなり、しわの幅が狭くなった</span>ことがわかりました。<br />さらに「シワ個数」と「シワ体積率」を数字で算出したところ、数値でも減少していることがわかりました。これにより私たちは、<span class="pink large bold">質のいい睡眠はしわに効果がある</span>と考えるにいたりました。</p>
              </div>
            </div>
          </div>
        </div>
