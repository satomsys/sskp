...
<head>
  ...
  <title>クワンソウ｜ねむりとめぐりの研究所｜飲む＆食べるドモホルンリンクル＜公式＞</title>
  <meta name="description" content="沖縄で、古くから親しまれてきたクワンソウは、別名「眠り草」と呼ばれます。眠れないときにクワンソウを食べると熟睡できると伝えられています。">
  <meta name="keywords" content="ドモホルンリンクル,ドモホルン,ドモ,再春館製薬所,再春館,成分,配合成分,クランソウ">
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.saishunkan.co.jp/domo/beautyhabit/lab/raw_material01.html">
  <meta property="og:title" content="クワンソウ｜ねむりとめぐりの研究所｜飲む＆食べるドモホルンリンクル＜公式＞">
  <meta property="og:description" content="沖縄で、古くから親しまれてきたクワンソウは、別名「眠り草」と呼ばれます。眠れないときにクワンソウを食べると熟睡できると伝えられています。" />
    ...
    <div class="header">
      <div class="header_inner">
        ...
        <div class="h2_container sp">
          <h2>
            <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/01_sp.png" alt="眠りの質を高め、疲れを和らげるクワンソウ" />
          </h2>
        </div><!-- .h2_container sp -->
        <div class="h2_container pc" style="margin-top:44px;">
          <h2>
            <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/01_pc.png" alt="眠りの質を高め、疲れを和らげるクワンソウ" />
          </h2>
        </div><!-- .h2_container pc -->
      </div><!-- .header_inner -->
    </div><!-- .header -->
    ...
    <div class="content">
      <div class="content_inner clearfix">
        ...
        <div class="column_01">
          <div>
            <h6>
              <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/02_pc.png" alt="クワンソウはこんな方にオススメ" />
              <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/02_sp.png" alt="クワンソウはこんな方にオススメ" />
            </h6>
            <div class="box_clear">
              <div class="text_01">
                <ul class="raw_material_list">
                  <li><span class="bold">睡眠でお悩みの方</span></li>
                  <li><span class="bold">疲労が取れない方</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <h3>
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/03_pc.png" alt="クワンソウとは？" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/03_sp.png" alt="クワンソウとは？" />
        </h3>
          ...
          <div>
            <div class="box_clear">
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/04_pc.png" alt="クワンソウ" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/04_sp.png" alt="クワンソウ" />
              </div>
              <div class="text_01">
                <p>クワンソウとは、沖縄に自生している植物で、茎や花は野菜として、葉はお茶として、古くから親しまれてきました。琉球王朝時代には、中国からの使者を迎える宮廷料理としても食されていたそうです。</p>
                <p>古くから親しまれてきたクワンソウは、別名「眠り草」と呼ばれます。<span class="pink large bold">眠れないときにクワンソウを食べると熟睡できる</span>と伝えられており、たくさんの屋敷に植えられていたそうです。<br />最近では、このクワンソウの持つ「睡眠に対する効果」が注目されています。</p>
              </div>
              <div class="img_container">
                <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/05_pc.png" alt="※生産地：日本（沖縄県）沖縄の眩しい太陽を浴び、青々と茂ったクワンソウは 生命力の強さを感じさせてくれます。少しでも良質のクワンソウを届けるために、栽培から出荷まで、雑草抜きや収穫など多くの工程が生産者の方々の手作業で行われており、生産者の愛情が込められています。" />
                <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/05_sp.png" alt="※生産地：日本（沖縄県）沖縄の眩しい太陽を浴び、青々と茂ったクワンソウは 生命力の強さを感じさせてくれます。少しでも良質のクワンソウを届けるために、栽培から出荷まで、雑草抜きや収穫など多くの工程が生産者の方々の手作業で行われており、生産者の愛情が込められています。" />
              </div>
            </div>
          </div>
        </div>
        ...
        <h3>
          <img class="pc" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/06_pc.png" alt="クワンソウは、眠りの質を高める" />
          <img class="sp" src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/06_sp.png" alt="クワンソウは、眠りの質を高める" />
        </h3>
        
        <div class="column_02 clearfix raw_material01_03">
          <div>
            <div class="box_clear">
              <div class="img_container sp">
                <img src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/07_sp.png" alt="クワンソウは、眠りの質を高める" />
              </div>
              <div class="raw_material01_03_01">
                <p>昔から眠り草として親しまれてきたクワンソウ。 最新の研究から、<span class="pink large bold">クワンソウエキスを飲む事で、深い眠りが持続</span>し、睡眠途中の目覚めが抑えられることが分かってきました。<br />質のよい睡眠は、お肌の生まれ変わりを促し、 美肌を保つと考えられています。 <br />これらの研究からクワンソウエキスは、睡眠の質をよくすることで、疲労を和らげ、お肌を健やかに保つことが期待できます。</p>
              </div>
            </div>
          </div>
          <div class="pc">
            <div class="box_clear">
              <img src="/assets/ps/domo/beautyhabit/lab/img/raw_material01/07_pc.png" alt="クワンソウは、眠りの質を高める" />
            </div>
          </div>
        </div>
