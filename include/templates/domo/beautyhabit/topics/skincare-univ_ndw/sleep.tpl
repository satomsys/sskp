...
<link rel="stylesheet" type="text/css" href="/assets/ps/domo/beautyhabit/topics/css/topics.css">
	...
	<link rel="stylesheet" type="text/css" href="css/sp_sleep.css" media="only screen and (min-width: 0px) and (max-width: 568px)" />
	...
	<link rel="stylesheet" type="text/css" href="css/pc_sleep.css" media="only screen and (min-width: 569px)" />
...
[:include file="domo/beautyhabit/_sp_navi.inc.tpl":]
	...
	<div class="page-topics bg-brown">
		...
		<!-- contents -->
		<div id="contents">
			<div class="innr cmn_wrap">
				<!-- vsl -->
				<div class="cmn_vsl">
					<div class="ttl_box">
						<p class="img">
							<img class="pc" src="images/sec02_vsl.png" alt="美肌をはぐくむ 上質な睡眠">
							<img class="sp" src="images/sp/sec02_vsl.png" alt="美肌をはぐくむ 上質な睡眠">
						</p>
						<h2 class="ttl">
							<img class="pc" src="images/sec02_ttl.png" alt="美肌をはぐくむ 上質な睡眠">
							<img class="sp" src="images/sp/sec02_ttl.png" alt="美肌をはぐくむ 上質な睡眠">
						</h2>
					</div>
					<ul class="nav">
						<li class="nav01">
							<a class="hover_img" href="index.html">
								<img class="pc" src="images/cmn_nav01.png" alt="寝ている間にキレイが育つ「リセット美容」始めよう">
								<img class="sp" src="images/sp/cmn_nav01.png" alt="寝ている間にキレイが育つ「リセット美容」始めよう">
							</a>
						</li>
						<li class="nav02">
							<a class="hover_img" href="repair.html">
								<img class="pc" src="images/cmn_nav02.png" alt="シワ・シミ予防のカギ「修復力」とは">
								<img class="sp" src="images/sp/cmn_nav02.png" alt="シワ・シミ予防のカギ「修復力」とは">
							</a>
						</li>
						<li class="nav03">
							<a class="hover_img" href="sleep.html">
								<img class="pc" src="images/cmn_nav03.png" alt="美肌をはぐくむ上質な睡眠">
								<img class="sp" src="images/sp/cmn_nav03.png" alt="美肌をはぐくむ上質な睡眠">
							</a>
						</li>
						<li class="nav04">
							<a class="hover_img" href="support.html">
								<img class="pc" src="images/cmn_nav04.png" alt="おやすみ前のキレイサポート">
								<img class="sp" src="images/sp/cmn_nav04.png" alt="おやすみ前のキレイサポート">
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="cmn_blk">
					...
					<div class="media">
						...
						<div class="bd">
							<p>女性の肌悩みの代表格といえば、シワとシミですよね。加齢も原因の一つですが、大きく影響するのは日中に受ける肌ダメージです。美しい肌を保つためには、ダメージ要因を避けること、受けたダメージはその日のうちにリセットすることが鍵になります。</p>
						</div>
					</div>
					<!-- /media -->
					<!-- blk -->
					<div class="blk_top">
						<p class="sub">
							<img class="pc" src="images/sec02_sub01.png" alt="成長ホルモンの分泌は時間より「質」が決め手！">
							<img class="sp" src="images/sp/sec02_sub01.png" alt="成長ホルモンの分泌は時間より「質」が決め手！">
						</p>
						<ul class="point_list">
							<li class="point01">
								<p class="min">睡眠開始から3時間の睡眠の質を上げよう</p>
								<p class="txt">日中に受けた肌ダメージは、睡眠中に修復されます。ただし、寝れば寝るほど良いわけではありません。細胞の修復を促す「成長ホルモン」は、睡眠開始後、3時間以内に質のいい深い眠りに入ると分泌されます。休日の「寝だめ」も、肌にとっては無意味。毎日の睡眠の「質」を大事にしてください。</p>
							</li>
							<li class="point02">
								<p class="min">自然な眠りにいざなう体内時計のリズム</p>
								<p class="txt">なかなか寝つけないとき、眠りが浅いときは、体内時計が乱れている可能性があります。朝太陽とともに目覚め、夜になると自然に眠くなるのは、体に備わる体内時計が一定のリズムを刻んでいるためです。朝～夜のすごし方を工夫して、睡眠の質を高めましょう。</p>
							</li>
						</ul>
					</div>
					<!-- /blk -->
				...
				<!-- /cmn_blk -->
				<h2 class="ttl_blk pc">
					<img src="images/sec02_ttl02.png" alt="睡眠の質を高めるライフスタイル">
				</h2>
				<!-- cmn_blk -->
				<div class="cmn_blk cmn_btm">
					<h2 class="ttl_blk sp"><img src="images/sp/sec02_ttl02.png" alt="睡眠の質を高めるライフスタイル"></h2>
					<!-- blk -->
					<ul class="blk_life">
						<li>
							<p class="thm">
								<img class="pc" src="images/sec02_thm01.png" alt="07:30 AM">
								<img class="sp" src="images/sp/sec02_thm01.png" alt="07:30 AM">
							</p>
							<p class="txt">
								<span>07:30</span>AM<br>
								乱れた体内時計は、光を浴びることでリセットされます。夜ふかしした日も、毎朝決まった時間に起きて太陽を浴びましょう。曇りの日は、明るい場所でメイクするのもおすすめです。
							</p>
						</li>
						<li class="rgt">
							<p class="thm">
								<img class="pc" src="images/sec02_thm02.png" alt="17:00 PM">
								<img class="sp" src="images/sp/sec02_thm02.png" alt="17:00 PM">
							</p>
							<p class="txt">
								<span>17:00</span>PM<br>
								夕方は、1日の中でもっとも体温が高くなる時間帯。軽い運動を行い、適度な疲労を与えると、夜には体温が大きく低下して寝つきがよくなります。通勤・買い物のときは、いつもより歩幅を開き、早足で歩くだけでもいい運動に。
							</p>
						</li>
						<li>
							<p class="thm">
								<img class="pc" src="images/sec02_thm03.png" alt="22:00 PM">
								<img class="sp" src="images/sp/sec02_thm03.png" alt="22:00 PM">
							</p>
							<p class="txt">
								<span>22:00</span>PM<br>
					...
					<div class="blk_btm">
						<p class="sub">
							<img class="pc" src="images/sec02_sub02.png" alt="寝る前の飲み物も睡眠と肌に差をつける">
							<img class="sp" src="images/sp/sec02_sub02.png" alt="寝る前の飲み物も睡眠と肌に差をつける">
						</p>
						<!-- list -->
						<div class="col02 cf">
							<div class="col">
								<p class="min">寝酒は厳禁</p>
								<p class="txt">「眠れないときは寝酒する」という行為は逆効果。アルコールを摂取した直後は、高くなった体温が急激に下がるため眠くなります。しかし、摂取から3時間後には体温が上昇。眠りが浅くなってしまいます。ホットミルクやノンカフェインのホットティーがおすすめです。</p>
							</div>
							<div class="col">
								<p class="min">美容成分は夜に摂取</p>
								<p class="txt">睡眠中は肌の血管が開き、ゆっくりと血流量が上がっていくため、寝る前に美容ドリンクを飲むのもよいでしょう。血流とともに美容成分をめぐらせることで、睡眠中の修復力のサポートが期待できます。ただし、美容ドリンクにはカフェインを含むものがあるので注意してください。カフェインをとると脳が覚醒し、眠りを妨げてしまいます。</p>
							</div>
						</div>
						<!-- /list -->
						<!-- btm -->
						<p class="btm">
							<img src="images/sec02_btm01.png" alt="眠りの質を高め、美しさを育む美容成分に注目しましょう！">
						</p>
						<!-- /btm -->
						<!-- note -->
						<p class="note">
						※ドクターによる監修は一般論に関してのみとなり、このページは広告ではありません。<br>
					...
					<!-- btm_btn -->
					<p class="btm_btn">
						<a href="./support.html" class="hover_img">
							おやすみ前のキレイサポート
						</a>
					</p>
					<!-- /btm_btn -->
