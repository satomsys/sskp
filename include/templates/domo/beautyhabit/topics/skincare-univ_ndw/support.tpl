...
<link rel="stylesheet" type="text/css" href="/assets/ps/domo/beautyhabit/topics/css/topics.css">
	...
	<link rel="stylesheet" type="text/css" href="css/sp_support.css" media="only screen and (min-width: 0px) and (max-width: 568px)" />
	...
	<link rel="stylesheet" type="text/css" href="css/pc_support.css" media="only screen and (min-width: 569px)" />
		...
		<div id="contents">
			<div class="innr cmn_wrap">
				...
				<div class="cmn_vsl">
					<div class="ttl_box">
						<p class="img">
							<img class="pc" src="images/sec03_vsl.png" alt="おやすみ前のキレイサポート">
							<img class="sp" src="images/sp/sec03_vsl.png" alt="おやすみ前のキレイサポート">
						</p>
						<h2 class="ttl">
							<img class="pc" src="images/sec03_ttl.png" alt="おやすみ前のキレイサポート">
							<img class="sp" src="images/sp/sec03_ttl.png" alt="おやすみ前のキレイサポート">
						</h2>
					</div>
					<ul class="nav">
						<li class="nav01">
				...
				<div class="cmn_blk cmn_btm">
					...
					<div class="blk_top">
						<p class="sub">
							<img class="pc" src="images/sec03_sub01.png" alt="厳選したいおやすみ前の美容成分">
							<img class="sp" src="images/sp/sec03_sub01.png" alt="厳選したいおやすみ前の美容成分">
						</p>
						<p class="top_txt">
							日中のあれこれがリセットされる夜に<br class="sp">とりたい美容ドリンク。<br>
							寝ている間に効率よくキレイを<br class="sp">はぐくむためには、<br>
							「美しさの循環」と「すこやかな土台」がポイントです。<br>
							配合成分にこだわって選びましょう。
						</p>

						<h3 class="min01">美しさを循環させる成分</h3>
						<div class="col03 cf">
							<div class="col">

								<p class="thm"><a href="/domo/beautyhabit/lab/raw_material01.html"><img src="images/sec03_thm01.png" alt="クワンソウ"></a></p>
								<div class="txt_box">
									<a href="/domo/beautyhabit/lab/raw_material01.html"><h3 class="min02">クワンソウ</h3></a>
									<p class="txt">長寿県として知られる沖縄で、おやすみ前に食されてきた伝統的なハーブ。すっきりとした深い休息をサポートし、ハリを引き出します。</p>
								</div>
							</div>
							<div class="col">
								<p class="thm"><img src="images/sec03_thm02.png" alt="金時ショウガ、ゆず"></p>
								<div class="txt_box">
									<h3 class="min02">金時ショウガ、ゆず</h3>
									<p class="txt">古くから、冷える季節に愛されてきたぽかぽか食材。中でも金時ショウガは、めぐりを助ける成分が豊富に含まれています。</p>
								</div>
							</div>
							<div class="col">
								<p class="thm"><img src="images/sec03_thm03.png" alt="GABA"></p>
								<div class="txt_box">
									<h3 class="min02">GABA</h3>
									<p class="txt">はりつめた毎日をホッとさせてくれる健康成分。おだやかさをもたらし、ストレスの多い環境でがんばる方におすすめです。</p>
								</div>
							</div>
						</div>

						<h3 class="min01">すこやかさの土台をつくる成分</h3>
						<p class="txt">ピンッと弾むハリ感のみなもとコラーゲン、うるおいで満たすヒアルロン酸は、大人の美しさには欠かせない成分。すこやかさの土台をはぐくみ、年齢にとらわれない上向きな美しさを後押しします。</p>
					</div>
					<!-- /blk -->
					<!-- blk -->
					<div class="blk_btm">
						<div class="in_blk">
							<p class="sub">
								<img class="pc" src="images/sec03_sub02.png" alt="スキンケア大学編集部まとめ おやすみ美容にぴったり！ キレイ底上げドリンク">
								<img class="sp" src="images/sp/sec03_sub02.png" alt="スキンケア大学編集部まとめ おやすみ美容にぴったり！ キレイ底上げドリンク">
							</p>
							<div class="item_box">
								<p class="item">
									<img class="pc" src="images/sec03_item.png" alt="飲むドモホルンリンクル">
									<img class="sp" src="images/sp/sec03_item.png" alt="飲むドモホルンリンクル">
								</p>
								<div class="txt_box">
									<h3 class="min01">飲むドモホルンリンクル</h3>
									<p>『飲むドモホルンリンクル』は、ハリのなさやくすみが気になり始めた方におすすめの美容ドリンク。おやすみ時間の質をサポートするクワンソウ、GABAなどの成分が、すがすがしい朝へと導きます。鱧コラーゲンやプロテオグリカンなど、ドモホルンリンクルならではの美容成分もたっぷり。ノンカフェインだから、睡眠をさまたげないのもうれしいポイントです。刺激要因が多くダメージを受けやすい毎日も、寝ている間にリセット！朝、鏡を見るたびに、いきいきとした新しい自分に出会えそうですね。</p>
								</div>
							</div>

							<p class="btm_btn">
								<a href="/domo/beautyhabit/ndw.html" class="hover_img">
									<img src="images/sec03_btn.png" alt="飲むドモホルンリンクル詳しくはこちら">
								</a>
							</p>
						</div>
					</div>
