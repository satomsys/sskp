...
<head>
	...
	<title>朝の「めぐり美容」で差をつける！よどまない内側ケアのコツ｜ピックアップ・トピックス｜飲む＆食べるドモホルンリンクル＜公式＞</title>
	...
	<link rel="stylesheet" type="text/css" href="css/sp_index.css" media="only screen and (min-width: 0px) and (max-width: 568px)" />
	<link rel="stylesheet" type="text/css" href="css/pc_base.css" media="only screen and (min-width: 569px)" />
	<link rel="stylesheet" type="text/css" href="css/pc_index.css" media="only screen and (min-width: 569px)" />
			...
			<div class="page-topics bg-brown">
				...
				<div id="contents">
					...
					<div class="idx_wrap">
						...
						<div class="idx_vsl">
							<p class="vsl">
								<img class="pc" src="images/idx_vsl.jpg" alt="朝の「めぐり美容」で差をつける！">
								<img class="sp" src="images/sp/idx_vsl.png" alt="朝の「めぐり美容」で差をつける！">
							</p>
							<p class="ttl">
								<img class="pc" src="images/idx_vsl_ttl.png" alt="朝の「めぐり美容」で差をつける！よどまない 内側ケアのコツ">
								<img class="sp" src="images/sp/idx_vsl_ttl.png" alt="朝の「めぐり美容」で差をつける！よどまない 内側ケアのコツ">
							</p>
							<p class="sub">
								<img class="pc" src="images/idx_vsl_sub.png" alt="Check 最近、こんな不調が 気になりませんか？">
								<img class="sp" src="images/sp/idx_vsl_sub.png" alt="Check 最近、こんな不調が 気になりませんか？">
							</p>
							<div class="list">
								<ul>
									<li>なんだか顔色がさえない</li>
									<li>むくみやすく、太ったようにみえる</li>
									<li>化粧のりが悪く、<br>ファンデーションが浮いてしまう</li>
									<li>若い子と一緒に写真を撮ると、<br>肌つやのなさが際立つ</li>
								</ul>
							</div>
						</div>
						<!-- /vsl -->
						...
						<ul class="idx_nav pc">
							<li>
								<a class="hover_img" href="step01.html">
									<img src="images/idx_nav01.png" alt="1  代謝の悪さが「くすみ」と「むくみ」を招く">
								</a>
							</li>
							<li>
								<a class="hover_img" href="step02.html">
									<img src="images/idx_nav02.png" alt="2 早起きは美人をつくる。朝活のススメ">
								</a>
							</li>
							<li>
								<a class="hover_img" href="step03.html">
									<img src="images/idx_nav03.png" alt="3 美しさは内側からつくられる">
								</a>
							</li>
						</ul>
						<!-- /PC navi -->
						...
						<div class="idx_blk">
							<p class="ttl">
								<img class="pc" src="images/idx_blk_ttl.png" alt="Prelude">
								<img class="sp" src="images/sp/idx_blk_ttl.png" alt="Prelude">
							</p>
							<div class="txt_box">
								<div class="box">
									<p>
									年齢とともに感じる肌や体の不調には、<br class="pc">
									「めぐりの悪化」が大きく影響します。<br class="pc">
									めぐりをよくするための秘訣は、<br class="pc">
									朝の活動「朝活」にアリ。
									<span class="sp">いきいきした大人のキレイをはぐくみませんか？</span>
									</p>
								</div>
								<p class="catch pc">
									<img src="images/idx_blk_catch.png" alt="いきいきした大人のキレイをはぐくみませんか？">
								</p>
							</div>
							<p class="thm">
								<img class="pc" src="images/idx_blk_thm.png" alt="朝活でキレイをはぐくむ">
								<img class="sp" src="images/sp/idx_blk_thm.jpg" alt="朝活でキレイをはぐくむ">
							</p>
						</div>
						<!-- /blk -->
						<!-- SP navi -->
						<ul class="idx_nav sp">
							<li>
								<a href="step01.html">
									<img src="images/sp/idx_nav01.png" alt="1  代謝の悪さが「くすみ」と「むくみ」を招く">
								</a>
							</li>
							<li>
								<a href="step02.html">
									<img src="images/sp/idx_nav02.png" alt="2 早起きは美人をつくる。朝活のススメ">
								</a>
							</li>
							<li>
								<a href="step03.html">
									<img src="images/sp/idx_nav03.png" alt="3 美しさは内側からつくられる">
								</a>
							</li>
						</ul>
						<!-- /SP navi -->
