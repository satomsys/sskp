(function ($) {
  ...
  function bh_more_hide(){
    $('.bh-more').fadeOut("slow");
    return;
  }
  ...
  function masonaryRandom() {
    if($('.bh-articleList__list').length) {
      ...
      _list.each(function() {
        ...
        $(this).children('.bh-articleList__list__li:nth-child(12n+4)').addClass('bh-horizonal');
        $(this).children('.bh-articleList__list__li:nth-child(12n+8)').addClass('bh-horizonal');
        $(this).children('.bh-articleList__list__li:nth-child(12n+9)').addClass('bh-horizonal');
        $(this).children('.bh-articleList__list__li:nth-child(12n+14)').addClass('bh-horizonal');
      });
    }
  }
...
　// パネルをスクロールに沿って表示
  function bh_graduallydisplay() {
    $('.bh-about__list__li').each(function(i){
